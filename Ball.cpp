...
Ball::Ball(float radius, sf::Color color)
	...
	m_totalTime(0), m_magnusForce(0), m_totalForce(0), speen(-2*M_PI*10)
{
...
void Ball::doMagnus()
{
	//Tror inte man kan använda den formeln här. Måste på något sätt kunna hitta delta-alfa för bollen. 
